...
- **One-tap launch capsule** compiles and copies the prompt, creates a numbered visual board locally, then opens Google AI Mode in a standard browser-owned Custom Tab with normal back and close controls.
...
- AndroidX Browser 1.10.0 standard Custom Tabs
